package main.java.transaction.trade;

import java.util.List;


/**
 * An concrete class in the Trade system representing a permanent trade (i.e., the items will not be returned)
 * @author Warren Zhu
 * @version %I%, %G%
 * @since Phase 2
 */
public class PermanentTrade extends Trade {
    ...
    /** Initialize a new instance of PermanentTrade.
     *
